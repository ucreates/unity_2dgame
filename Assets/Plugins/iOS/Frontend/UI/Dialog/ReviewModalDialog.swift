...
import Foundation
import UIKit
public class ReviewModalDialog : NSObject {
    public class func show(appStoreUrl:String){
        ...
        let glViewController = GLViewController.GetController();
        glViewController.presentViewController(alert, animated: true, completion: nil);
    }
}